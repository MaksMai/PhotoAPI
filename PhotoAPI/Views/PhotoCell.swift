...
class PhotoCell: UITableViewCell {
    ...
    func setupConstrains() {
        NSLayoutConstraint.activate([ // ограничения картинки
        ...
        NSLayoutConstraint.activate([ // ограничения размытия
        ...
        NSLayoutConstraint.activate([ // ограничения photographerTagLabel photographerLabel
